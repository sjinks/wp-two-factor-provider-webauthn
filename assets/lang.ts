...
export const L_UNABLE_TO_GET_PK_CREDENTIAL = __(
	'Unable to get a public key credential.',
...
export const L_FAILED_TO_CREATE_CREDENTIALS = __(
	'Unable to create public key credentials',
	'two-factor-provider-webauthn',
);
